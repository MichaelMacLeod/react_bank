	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        Number(bank.totalCash()).toLocaleString(),
	        ' '
	      ),
	      React.createElement(AccountBox, { type: 'business', accounts: bank.filteredAccounts('business'), title: 'Business Accounts: ', bank: bank }),
	      React.createElement(AccountBox, { type: 'personal', accounts: bank.filteredAccounts('personal'), title: 'Personal Accounts: ', bank: bank })
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Total in accounts: £',
	        Number(this.props.bank.totalCash(this.props.type)).toFixed(2).toLocaleString(),
	        ' '
	      ),
	      React.createElement(AccountList, { title: 'Account Holders:', type: this.props.type, bank: this.props.bank })
	    );
	  }
	});
